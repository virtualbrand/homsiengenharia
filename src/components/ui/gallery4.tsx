...
const Gallery4 = ({
  ...
  return (
    <section id={sectionId} className="py-32">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="mb-2 grid grid-cols-12">
          <div className="col-span-12 md:col-span-8 flex flex-col gap-2">
            <h2 className="fade-in text-3xl md:text-5xl font-bold leading-tight">
              {title}
            </h2>
            <p className="fade-in text-lg text-gray-700 leading-relaxed">{description}</p>
          </div>
          <div className="hidden md:flex md:col-span-6 shrink-0 gap-2 justify-end items-end">
            <Button
              size="icon"
              variant="ghost"
              onClick={() => {
      ...
      <div className="fade-in w-full overflow-hidden relative">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <Carousel
        ...
        <div className="absolute top-0 right-0 h-full w-64 bg-gradient-to-l from-white via-white/80 to-transparent pointer-events-none z-50" />
        </div>
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
