  ...
  const serviceMarkers = [
    {
      ...
      popup: {
        ...
        content: 'Sede da Homsi Engenharia. Atendemos toda a região metropolitana com serviços de construção e reforma de alto padrão.'
      }
    },
    {
      id: 'nova-lima',
      ...
      popup: {
        title: 'Nova Lima',
        content: 'Atendemos Nova Lima com expertise em construções residenciais e comerciais de luxo.'
      }
    },
    {
      id: 'lagoa-santa',
      ...
      popup: {
        title: 'Lagoa Santa',
        content: 'Prestamos serviços em Lagoa Santa com foco em qualidade e excelência construtiva.'
      }
    }
  ];
  ...
  const serviceAreas = [
    {
      ...
      popup: 'Área de atendimento - Belo Horizonte'
    },
    {
      id: 'nova-lima-area',
      ...
      style: { color: '#D6BDAA', weight: 2, fillOpacity: 0.1 },
      popup: 'Área de atendimento - Nova Lima'
    },
    {
      id: 'lagoa-santa-area',
      ...
      radius: 15000, // 15km radius
      style: { color: '#D6BDAA', weight: 2, fillOpacity: 0.1 },
      popup: 'Área de atendimento - Lagoa Santa'
    }
  ];
